...
// Pano2VR 6.0.1/17227
// Filename: Monta�a Virtual.ggsk
// Generated mar mar. 16 14:15:05 2021
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('3D', 0, "");
	player.addVariable('var_compass', 2, false);
	player.addVariable('animation', 2, false);
	player.addVariable('vis_info_popup_2', 2, false);
	player.addVariable('Open_portada', 2, false);
	var me=this;
	var skin=this;
	var flag=false;
	...
	this.addSkin=function() {
		...
		me._screentint.onclick=function (e) {
			...
			player.setVariableValue('Open_portada', false);
		}
		...
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 496px; height: 15px; background-color: rgba(255,255,255,0.392157); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._thumbnail_menu__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 496px; height: 15px; background-color: rgba(255,255,255,1); pointer-events: auto;');
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 352px; background-color: rgba(255,255,255,0.392157); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._thumbnail_menu_mobile__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 352px; background-color: rgba(255,255,255,1); pointer-events: auto;');
		...
		el=me._compasspointer=document.createElement('div');
		els=me._compasspointer__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		me._compasspointer__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;compasspointer;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="CompassPointer";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		hs+='width : 100px;';
		hs+='pointer-events:none;';
		hs+='#CompassPointer{ backgroundcolor: #fff; }';
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._compasspointer.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._compasspointer.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
			...
			if (me._compasspointer.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._compasspointer.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._compasspointer.style[domTransition]='';
				if (me._compasspointer.ggCurrentLogicStateVisible == 0) {
					me._compasspointer.style.visibility=(Number(me._compasspointer.style.opacity)>0||!me._compasspointer.style.opacity)?'inherit':'hidden';
					me._compasspointer.ggVisible=true;
				}
				else {
					me._compasspointer.style.visibility="hidden";
					me._compasspointer.ggVisible=false;
				}
			}
		}
		me._compasspointer.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._compass.appendChild(me._compasspointer);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		me._compassbeam__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;compassbeam;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="CompassBeam";
		...
		me._image_popup.appendChild(me._rectangle_10);
		...
		me._container_1.appendChild(me._popup_image);
		...
		el=me._info_text_body_2=document.createElement('div');
		els=me._info_text_body_2__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="info_text_body_2";
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._info_text_body_2.ggUpdateText=function() {
		...
		me._info_text_body_2.ggUpdateText();
		el.appendChild(els);
		me._info_text_body_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._info_text_body_2.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._container_1.appendChild(me._info_text_body_2);
		me._image_popup.appendChild(me._container_1);
		...
		me._information_2.logicBlock_visible = function() {
			...
			if (me._information_2.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._information_2.style[domTransition]='';
		...
		el=me._rectangle_1_2=document.createElement('div');
		el.ggId="Rectangle 1_2";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._rectangle_1_2.onclick=function (e) {
			player.setVariableValue('vis_image_popup', false);
			player.setVariableValue('vis_info_popup', false);
			player.setVariableValue('vis_video_popup_file', false);
			player.setVariableValue('vis_video_popup_url', false);
		...
		me._rectangle_1_2.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._information_2.appendChild(me._rectangle_1_2);
		...
		me._information_2.appendChild(me._informationbg_2);
		el=me._info_text_body_3=document.createElement('div');
		els=me._info_text_body_3__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="info_text_body_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._info_text_body_3.ggUpdateText=function() {
			var hs=player.hotspot.description+"<iframe src=\"includes\/3d_2.html\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._info_text_body_3.ggUpdateText();
		el.appendChild(els);
		me._info_text_body_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._info_text_body_3.ggUpdatePosition=function (useTransition) {
		}
		me._information_2.appendChild(me._info_text_body_3);
		el=me._info_title_2=document.createElement('div');
		els=me._info_title_2__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="info_title_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._info_title_2.ggUpdateText=function() {
		...
		me._info_title_2.ggUpdateText();
		el.appendChild(els);
		me._info_title_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._info_title_2.ggUpdatePosition=function (useTransition) {
		}
		me._information_2.appendChild(me._info_title_2);
		el=me._ht_info_close_2=document.createElement('div');
		els=me._ht_info_close_2__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			...
			''+
			'';
		me._ht_info_close_2__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_info_close_2;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._ht_info_close_2__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			...
			''+
			'w3LjE0N2MtMC4wMDEsMi41OTItMC45ODQsNS4xNy0yLjk2LDcuMTQ4DQoJCUMyMS4xNywyNS4xMjMsMTguNTkxLDI2LjEwNywxNiwyNi4xMDZ6Ii8+DQo8L2c+DQo8L3N2Zz4NCg==';
		me._ht_info_close_2__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_info_close_2;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		el.ggId="ht_info_close_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_svg ";
		el.ggType='svg';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_info_close_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_info_close_2.onclick=function (e) {
			player.setVariableValue('vis_info_popup_2', false);
		}
		me._ht_info_close_2.onmouseover=function (e) {
			me._ht_info_close_2__img.style.visibility='hidden';
			me._ht_info_close_2__imgo.style.visibility='inherit';
		}
		me._ht_info_close_2.onmouseout=function (e) {
			me._ht_info_close_2__img.style.visibility='inherit';
			me._ht_info_close_2__imgo.style.visibility='hidden';
		}
		me._ht_info_close_2.ggUpdatePosition=function (useTransition) {
		}
		me._information_2.appendChild(me._ht_info_close_2);
		...
		el=me._rectangle_1_3=document.createElement('div');
		el.ggId="Rectangle 1_3";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._rectangle_1_3.onclick=function (e) {
			player.setVariableValue('vis_image_popup', false);
			player.setVariableValue('vis_info_popup', false);
			player.setVariableValue('vis_video_popup_file', false);
			player.setVariableValue('vis_video_popup_url', false);
		...
		me._rectangle_1_3.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._information.appendChild(me._rectangle_1_3);
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		els.innerHTML="<iframe src=\"includes\/3d.html\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
		el.appendChild(els);
		...
		me._video_popup_file.appendChild(me._rectangle_1);
		...
		el=me._information_3=document.createElement('div');
		el.ggId="information_3";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._information_3.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._information_3.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('Open_portada') == true)
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._information_3.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._information_3.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._information_3.style[domTransition]='';
				if (me._information_3.ggCurrentLogicStateVisible == 0) {
					me._information_3.style.visibility=(Number(me._information_3.style.opacity)>0||!me._information_3.style.opacity)?'inherit':'hidden';
					me._information_3.ggVisible=true;
				}
				else {
					me._information_3.style.visibility="hidden";
					me._information_3.ggVisible=false;
				}
			}
		}
		me._information_3.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		el=me._rectangle_1_4=document.createElement('div');
		el.ggId="Rectangle 1_4";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._rectangle_1_4.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._information_3.appendChild(me._rectangle_1_4);
		el=me._informationbg_3=document.createElement('div');
		el.ggId="informationbg_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		el.ggType='rectangle';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._informationbg_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._informationbg_3.ggUpdatePosition=function (useTransition) {
		}
		me._information_3.appendChild(me._informationbg_3);
		el=me._info_text_body_4=document.createElement('div');
		els=me._info_text_body_4__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="info_text_body_4";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._info_text_body_4.ggUpdateText=function() {
			var hs=player.hotspot.description+"<iframe src=\"includes\/portada\/index.html\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._info_text_body_4.ggUpdateText();
		el.appendChild(els);
		me._info_text_body_4.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._info_text_body_4.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._information_3.appendChild(me._info_text_body_4);
		el=me._info_title_3=document.createElement('div');
		els=me._info_title_3__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="info_title_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._info_title_3.ggUpdateText=function() {
			var hs=player.hotspot.title;
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
		...
		me._info_title_3.ggUpdateText();
		el.appendChild(els);
		me._info_title_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._info_title_3.ggUpdatePosition=function (useTransition) {
		}
		me._information_3.appendChild(me._info_title_3);
		el=me._ht_info_close_3=document.createElement('div');
		els=me._ht_info_close_3__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			...
			''+
			'';
		me._ht_info_close_3__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_info_close_3;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._ht_info_close_3__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			...
			''+
			'w3LjE0N2MtMC4wMDEsMi41OTItMC45ODQsNS4xNy0yLjk2LDcuMTQ4DQoJCUMyMS4xNywyNS4xMjMsMTguNTkxLDI2LjEwNywxNiwyNi4xMDZ6Ii8+DQo8L2c+DQo8L3N2Zz4NCg==';
		me._ht_info_close_3__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_info_close_3;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		el.ggId="ht_info_close_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_svg ";
		el.ggType='svg';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_info_close_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_info_close_3.onclick=function (e) {
			player.setVariableValue('Open_portada', false);
			me._information_3.style[domTransition]='none';
			me._information_3.style.visibility='hidden';
			me._information_3.ggVisible=false;
		}
		me._ht_info_close_3.onmouseover=function (e) {
			me._ht_info_close_3__img.style.visibility='hidden';
			me._ht_info_close_3__imgo.style.visibility='inherit';
		}
		me._ht_info_close_3.onmouseout=function (e) {
			me._ht_info_close_3__img.style.visibility='inherit';
			me._ht_info_close_3__imgo.style.visibility='hidden';
		}
		me._ht_info_close_3.ggUpdatePosition=function (useTransition) {
		}
		me._information_3.appendChild(me._ht_info_close_3);
		me.divSkin.appendChild(me._information_3);
		...
		el=me._mapaicon=document.createElement('div');
		els=me._mapaicon__img=document.createElement('img');
		els.className='ggskin ggskin_mapaicon';
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;.mapaicon:hover {transform: scale(1.5); };');
		...
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_button mapaicon";
		el.ggType='button';
		hs ='';
		hs+='bottom : 15px;';
		hs+='height : 40px;';
		...
		hs+='width : 40px;';
		hs+='pointer-events:auto;';
		hs+='hover: transform: scale(1.5);';
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._mapaicon.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._mapaicon.onclick=function (e) {
		...
		me._mapaicon.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._mapaicon);
		...
		me._timer_1.ggActivate=function () {
			player.setVariableValue('animation', !player.getVariableValue('animation'));
		}
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'69Mw8jI5D+NWahTQetkXeBOVpqAlyDAc5bnpR260c5BBOYp55TbdOmo6clPOijn+ZUTv4LEAuQKdO25/NDXNCRy3DG/rbZAB/mSkBPl5KTKGd/m+9xrq1+R7USlLf9tB4s5xf3St3DmtKPcpSrNegM4rab/QFcjVfDLRhX/Xor2mOn3Hn0ilR6mn3NfXlfvyBhRbYSLo6iwoyBVFXnxBW/H/MnDoXfoZ5scAAAAASUVORK5CYII=';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
	...
	me.callChildLogicBlocksHotspot_ht_node_changenodeid = function(){
		if(hotspotTemplates['ht_node']) {
			...
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				...
				if (hotspotTemplates['ht_node'][i]._hsimage0 && hotspotTemplates['ht_node'][i]._hsimage0.logicBlock_scaling) {
					hotspotTemplates['ht_node'][i]._hsimage0.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_node'][i]._hsimage0 && hotspotTemplates['ht_node'][i]._hsimage0.logicBlock_alpha) {
					hotspotTemplates['ht_node'][i]._hsimage0.logicBlock_alpha();
				}
	...
	me.callChildLogicBlocksHotspot_ht_node_varchanged_animation = function(){
		if(hotspotTemplates['ht_node']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (hotspotTemplates['ht_node'][i]._hsimage0 && hotspotTemplates['ht_node'][i]._hsimage0.logicBlock_scaling) {
	...
	me.callChildLogicBlocksHotspot_ht_image_changenodeid = function(){
		if(hotspotTemplates['ht_image']) {
			...
			for(i = 0; i < hotspotTemplates['ht_image'].length; i++) {
				...
				if (hotspotTemplates['ht_image'][i]._ht_image_image_2 && hotspotTemplates['ht_image'][i]._ht_image_image_2.logicBlock_scaling) {
					hotspotTemplates['ht_image'][i]._ht_image_image_2.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_image'][i]._ht_image_image_2 && hotspotTemplates['ht_image'][i]._ht_image_image_2.logicBlock_alpha) {
					hotspotTemplates['ht_image'][i]._ht_image_image_2.logicBlock_alpha();
				}
	...
	me.callChildLogicBlocksHotspot_ht_image_varchanged_animation = function(){
		if(hotspotTemplates['ht_image']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_image'].length; i++) {
				if (hotspotTemplates['ht_image'][i]._ht_image_image && hotspotTemplates['ht_image'][i]._ht_image_image.logicBlock_scaling) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_changenodeid = function(){
		if(hotspotTemplates['ht_video_file']) {
			...
			for(i = 0; i < hotspotTemplates['ht_video_file'].length; i++) {
				...
				if (hotspotTemplates['ht_video_file'][i]._tt_ht_video_file1 && hotspotTemplates['ht_video_file'][i]._tt_ht_video_file1.logicBlock_visible) {
					hotspotTemplates['ht_video_file'][i]._tt_ht_video_file1.logicBlock_visible();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_video_file_configloaded = function(){
		if(hotspotTemplates['ht_video_file']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file'].length; i++) {
				if (hotspotTemplates['ht_video_file'][i]._tt_ht_video_file1 && hotspotTemplates['ht_video_file'][i]._tt_ht_video_file1.logicBlock_position) {
					hotspotTemplates['ht_video_file'][i]._tt_ht_video_file1.logicBlock_position();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_changenodeid = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
					hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible();
				}
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_alpha) {
					hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0 && hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0.logicBlock_scaling) {
					hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0 && hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0.logicBlock_alpha) {
					hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image_20 && hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image_20.logicBlock_alpha) {
					hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image_20.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image_20 && hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image_20.logicBlock_scaling) {
					hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image_20.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0 && hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0.logicBlock_visible) {
					hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0.logicBlock_visible();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_configloaded = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0 && hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0.logicBlock_position) {
					hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0.logicBlock_position();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_mouseover = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0 && hotspotTemplates['ht_video_file_mod_2'][i]._tt_ht_video_file0.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_timer = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_alpha) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_userdata = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_image_popup = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_info_popup = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_file = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_url = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_vimeo = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_youtube = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_website = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_mod_2.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_animation = function(){
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0 && hotspotTemplates['ht_video_file_mod_2'][i]._ht_video_file_image0.logicBlock_scaling) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_changenodeid = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
					hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible();
				}
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_alpha) {
					hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image && hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image.logicBlock_scaling) {
					hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image && hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image.logicBlock_alpha) {
					hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image_2 && hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image_2.logicBlock_alpha) {
					hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image_2.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image_2 && hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image_2.logicBlock_scaling) {
					hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image_2.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file && hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file.logicBlock_visible) {
					hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file.logicBlock_visible();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_video_file_mod_configloaded = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file && hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file.logicBlock_position) {
					hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file.logicBlock_position();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_video_file_mod_mouseover = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file && hotspotTemplates['ht_video_file_mod'][i]._tt_ht_video_file.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_timer = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_alpha) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_userdata = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_image_popup = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_info_popup = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_file = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_url = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_vimeo = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_youtube = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_website = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_mod.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_animation = function(){
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				if (hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image && hotspotTemplates['ht_video_file_mod'][i]._ht_video_file_image.logicBlock_scaling) {
	...
	me.callChildLogicBlocksHotspot_ht_3d_modele_2_changenodeid = function(){
		if(hotspotTemplates['ht_3d_modele_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele_2'].length; i++) {
				if (hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4 && hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4.logicBlock_scaling) {
					hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4 && hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4.logicBlock_alpha) {
					hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_3d_modele_2'][i].__3d_model_3 && hotspotTemplates['ht_3d_modele_2'][i].__3d_model_3.logicBlock_scaling) {
					hotspotTemplates['ht_3d_modele_2'][i].__3d_model_3.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_3d_modele_2'][i].__3d_model_3 && hotspotTemplates['ht_3d_modele_2'][i].__3d_model_3.logicBlock_alpha) {
					hotspotTemplates['ht_3d_modele_2'][i].__3d_model_3.logicBlock_alpha();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_3d_modele_2_mouseover = function(){
		if(hotspotTemplates['ht_3d_modele_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele_2'].length; i++) {
				if (hotspotTemplates['ht_3d_modele_2'][i]._ht_tt2 && hotspotTemplates['ht_3d_modele_2'][i]._ht_tt2.logicBlock_visible) {
					hotspotTemplates['ht_3d_modele_2'][i]._ht_tt2.logicBlock_visible();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_3d_modele_2_varchanged_animation = function(){
		if(hotspotTemplates['ht_3d_modele_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele_2'].length; i++) {
				if (hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4 && hotspotTemplates['ht_3d_modele_2'][i].__3d_model_4.logicBlock_scaling) {
	...
	me.callChildLogicBlocksHotspot_ht_3d_modele_changenodeid = function(){
		if(hotspotTemplates['ht_3d_modele']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele'].length; i++) {
				if (hotspotTemplates['ht_3d_modele'][i].__3d_model && hotspotTemplates['ht_3d_modele'][i].__3d_model.logicBlock_scaling) {
					hotspotTemplates['ht_3d_modele'][i].__3d_model.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_3d_modele'][i].__3d_model && hotspotTemplates['ht_3d_modele'][i].__3d_model.logicBlock_alpha) {
					hotspotTemplates['ht_3d_modele'][i].__3d_model.logicBlock_alpha();
				}
				if (hotspotTemplates['ht_3d_modele'][i].__3d_model_2 && hotspotTemplates['ht_3d_modele'][i].__3d_model_2.logicBlock_scaling) {
					hotspotTemplates['ht_3d_modele'][i].__3d_model_2.logicBlock_scaling();
				}
				if (hotspotTemplates['ht_3d_modele'][i].__3d_model_2 && hotspotTemplates['ht_3d_modele'][i].__3d_model_2.logicBlock_alpha) {
					hotspotTemplates['ht_3d_modele'][i].__3d_model_2.logicBlock_alpha();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_3d_modele_mouseover = function(){
		if(hotspotTemplates['ht_3d_modele']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele'].length; i++) {
				if (hotspotTemplates['ht_3d_modele'][i]._ht_tt && hotspotTemplates['ht_3d_modele'][i]._ht_tt.logicBlock_visible) {
					hotspotTemplates['ht_3d_modele'][i]._ht_tt.logicBlock_visible();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_3d_modele_varchanged_animation = function(){
		if(hotspotTemplates['ht_3d_modele']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele'].length; i++) {
				if (hotspotTemplates['ht_3d_modele'][i].__3d_model && hotspotTemplates['ht_3d_modele'][i].__3d_model.logicBlock_scaling) {
	...
	me.skinTimerEvent=function() {
		...
		var hs='';
		if (me._compasspointer.ggParameter) {
			hs+=parameterToTransform(me._compasspointer.ggParameter) + ' ';
		}
		hs+='rotate(' + (-1.0*(1 * player.getPanNorth() + 0)) + 'deg) ';
		me._compasspointer.style[domTransform]=hs;
		var hs='';
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs=basePath + 'images/hsimage0.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		me._hsimage0.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			{
				newLogicStateScaling = 0;
			}
			...
			if (me._hsimage0.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._hsimage0.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._hsimage0.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._hsimage0.ggCurrentLogicStateScaling == 0) {
					me._hsimage0.ggParameter.sx = 0.8;
					me._hsimage0.ggParameter.sy = 0.8;
					me._hsimage0.style[domTransform]=parameterToTransform(me._hsimage0.ggParameter);
				}
				else {
					me._hsimage0.ggParameter.sx = 1;
					me._hsimage0.ggParameter.sy = 1;
					me._hsimage0.style[domTransform]=parameterToTransform(me._hsimage0.ggParameter);
				}
			}
		}
		me._hsimage0.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._hsimage0.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._hsimage0.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._hsimage0.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._hsimage0.ggCurrentLogicStateAlpha == 0) {
					me._hsimage0.style.visibility="hidden";
					me._hsimage0.style.opacity=0;
				}
				else {
		...
		me._ht_node.appendChild(me._hsimage0);
		...
		me._hsimage.logicBlock_scaling = function() {
			...
			if (me._hsimage.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._hsimage.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._hsimage.ggCurrentLogicStateScaling == 0) {
					...
					me._hsimage.ggParameter.sx = 0.8;
					me._hsimage.ggParameter.sy = 0.8;
					me._hsimage.style[domTransform]=parameterToTransform(me._hsimage.ggParameter);
				}
			}
		}
	...
	function SkinHotspotClass_ht_url(parentScope,hotspot) {
		...
		hs='data:image/png;base64,'+
			''+
			''+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs='data:image/png;base64,'+
			''+
			''+
			'Gnf2BBYTzQ/Gaoib+mdtmxwhuAPQAAAABJRU5ErkJggg==';
		...
		els.className='ggskin ggskin_ht_url_image_newpage';
		hs='data:image/png;base64,'+
			''+
			''+
			'';
		...
		hs='data:image/png;base64,'+
			...
			''+
			'Gnf2BBYTzQ/Gaoib+mdtmxwhuAPQAAAABJRU5ErkJggg==';
		me._ht_url_image_newpage__img.ggOverSrc=hs;
		...
		me._ht_url_image_newpage.onmouseover=function (e) {
			me._ht_url_image_newpage__img.src=me._ht_url_image_newpage__img.ggOverSrc;
		}
		me._ht_url_image_newpage.onmouseout=function (e) {
			me._ht_url_image_newpage__img.src=me._ht_url_image_newpage__img.ggNormalSrc;
		}
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		me._ht_image.onclick=function (e) {
			...
			skin._info_text_body_2.ggText=me.hotspot.description;
			skin._info_text_body_2.ggTextDiv.innerHTML=skin._info_text_body_2.ggText;
			if (skin._info_text_body_2.ggUpdateText) {
				skin._info_text_body_2.ggUpdateText=function() {
			...
			if (skin._info_text_body_2.ggUpdatePosition) {
				skin._info_text_body_2.ggUpdatePosition();
			}
			skin._info_text_body_2.ggTextDiv.scrollTop = 0;
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;.image_icon:hover {transform: scale(1.5); };');
		els.className='ggskin ggskin_button';
		els['ondragstart']=function() { return false; };
		player.checkLoaded.push(els);
		el.appendChild(els);
		el.ggSubElement = els;
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			'';
		...
		el.ggParameter={ rx:0,ry:0,a:0,sx:0.8,sy:0.8 };
		el.ggVisible=true;
		el.className="ggskin ggskin_button image_icon";
		el.ggType='button';
		hs ='';
		hs+='cursor : pointer;';
		hs+='height : 50px;';
		...
		me._ht_image_image.logicBlock_scaling = function() {
			...
			if (me._ht_image_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._ht_image_image.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
		...
		me._ht_image_image.logicBlock_alpha = function() {
			...
			if (me._ht_image_image.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_image_image.ggCurrentLogicStateAlpha == 0) {
					...
					me._ht_image_image.style.opacity=0;
				}
				else {
		...
		el=me._ht_image_image_2=document.createElement('div');
		els=me._ht_image_image_2__img=document.createElement('img');
		els.className='ggskin ggskin_ht_image_image_2';
		hs='data:image/png;base64,'+
			''+
			''+
			''+
		...
		hs='data:image/png;base64,'+
			...
			''+
			'';
		me._ht_image_image_2__img.ggOverSrc=hs;
		el.ggId="ht_image_image_2";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._ht_image_image_2.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_image_image_2.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._ht_image_image_2.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._ht_image_image_2.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_image_image_2.ggCurrentLogicStateScaling == 0) {
					me._ht_image_image_2.ggParameter.sx = 0.8;
					me._ht_image_image_2.ggParameter.sy = 0.8;
					me._ht_image_image_2.style[domTransform]=parameterToTransform(me._ht_image_image_2.ggParameter);
				}
				else {
					me._ht_image_image_2.ggParameter.sx = 1;
					me._ht_image_image_2.ggParameter.sy = 1;
					me._ht_image_image_2.style[domTransform]=parameterToTransform(me._ht_image_image_2.ggParameter);
				}
			}
		}
		me._ht_image_image_2.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_image_image_2.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_image_image_2.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_image_image_2.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_image_image_2.ggCurrentLogicStateAlpha == 0) {
					me._ht_image_image_2.style.visibility=me._ht_image_image_2.ggVisible?'inherit':'hidden';
					me._ht_image_image_2.style.opacity=1;
				}
				else {
					me._ht_image_image_2.style.visibility="hidden";
					me._ht_image_image_2.style.opacity=0;
				}
			}
		}
		me._ht_image_image_2.onmouseover=function (e) {
			me._ht_image_image_2__img.src=me._ht_image_image_2__img.ggOverSrc;
		}
		me._ht_image_image_2.onmouseout=function (e) {
			me._ht_image_image_2__img.src=me._ht_image_image_2__img.ggNormalSrc;
		}
		me._ht_image_image_2.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_image.appendChild(me._ht_image_image_2);
	...
	function SkinHotspotClass_ht_video_file(parentScope,hotspot) {
		...
		me._ht_video_file.onmouseover=function (e) {
			...
			me._tt_ht_video_file1.logicBlock_visible();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		...
		el=me._ht_video_file_image1=document.createElement('div');
		els=me._ht_video_file_image1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_video_file_image1__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_file_image1;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._ht_video_file_image1__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_video_file_image1__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_file_image1;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_video_file_image1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_video_file_image1.onmouseover=function (e) {
			me._ht_video_file_image1__img.style.visibility='hidden';
			me._ht_video_file_image1__imgo.style.visibility='inherit';
		}
		me._ht_video_file_image1.onmouseout=function (e) {
			me._ht_video_file_image1__img.style.visibility='inherit';
			me._ht_video_file_image1__imgo.style.visibility='hidden';
		}
		me._ht_video_file_image1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_video_file.appendChild(me._ht_video_file_image1);
		el=me._tt_ht_video_file1=document.createElement('div');
		els=me._tt_ht_video_file1__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		...
		els.innerHTML=me.hotspot.title;
		el.appendChild(els);
		me._tt_ht_video_file1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._tt_ht_video_file1.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				(player.getIsMobile() == true)
			)
			...
			if (me._tt_ht_video_file1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._tt_ht_video_file1.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._tt_ht_video_file1.style[domTransition]='left 0s, top 0s';
				if (me._tt_ht_video_file1.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					me._tt_ht_video_file1.style.top='-50px';
					me._tt_ht_video_file1.ggUpdatePosition(true);
				}
				else {
					me._tt_ht_video_file1.ggDx=0;
					me._tt_ht_video_file1.style.top='22px';
					me._tt_ht_video_file1.ggUpdatePosition(true);
				}
			}
		}
		me._tt_ht_video_file1.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['ht_video_file'] == true) && 
				(me.hotspot.title != "")
			...
			if (me._tt_ht_video_file1.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._tt_ht_video_file1.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._tt_ht_video_file1.style[domTransition]='left 0s, top 0s';
				if (me._tt_ht_video_file1.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_video_file1.style.visibility=(Number(me._tt_ht_video_file1.style.opacity)>0||!me._tt_ht_video_file1.style.opacity)?'inherit':'hidden';
					me._tt_ht_video_file1.ggVisible=true;
				}
				else {
					me._tt_ht_video_file1.style.visibility="hidden";
					me._tt_ht_video_file1.ggVisible=false;
				}
			}
		}
		me._tt_ht_video_file1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_video_file.appendChild(me._tt_ht_video_file1);
		me.__div = me._ht_video_file;
	};
	function SkinHotspotClass_ht_video_file_mod_2(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_video_file_mod_2=document.createElement('div');
		el.ggId="ht_video_file_mod_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_video_file_mod_2.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return me.hotspot.url.substr(1, me.hotspot.url.length - 2);
		}
		me._ht_video_file_mod_2.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_userdata') == true) || 
				(player.getVariableValue('vis_image_popup') == true) || 
			...
			if (me._ht_video_file_mod_2.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._ht_video_file_mod_2.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._ht_video_file_mod_2.style[domTransition]='opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_mod_2.ggCurrentLogicStateVisible == 0) {
					me._ht_video_file_mod_2.style.visibility="hidden";
					me._ht_video_file_mod_2.ggVisible=false;
				}
				else {
					me._ht_video_file_mod_2.style.visibility=(Number(me._ht_video_file_mod_2.style.opacity)>0||!me._ht_video_file_mod_2.style.opacity)?'inherit':'hidden';
					me._ht_video_file_mod_2.ggVisible=true;
				}
			}
		}
		me._ht_video_file_mod_2.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('vis_timer') == true)
			)
			...
			if (me._ht_video_file_mod_2.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_video_file_mod_2.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_video_file_mod_2.style[domTransition]='opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_mod_2.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file_mod_2.style.visibility=me._ht_video_file_mod_2.ggVisible?'inherit':'hidden';
					me._ht_video_file_mod_2.style.opacity=1;
				}
				else {
					me._ht_video_file_mod_2.style.visibility="hidden";
					me._ht_video_file_mod_2.style.opacity=0;
				}
			}
		}
		me._ht_video_file_mod_2.onclick=function (e) {
			skin._popup_video_file.ggInitMedia(player.getBasePath()+""+me.hotspot.url);
			player.setVariableValue('vis_video_popup_file', true);
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod_2.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod_2.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['ht_video_file_mod_2']=true;
			me._tt_ht_video_file0.logicBlock_visible();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod_2.onmouseout=function (e) {
			player.setActiveHotspot(null);
			me.elementMouseOver['ht_video_file_mod_2']=false;
			me._tt_ht_video_file0.logicBlock_visible();
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod_2.ontouchend=function (e) {
			me.elementMouseOver['ht_video_file_mod_2']=false;
			me._tt_ht_video_file0.logicBlock_visible();
		}
		me._ht_video_file_mod_2.ggUpdatePosition=function (useTransition) {
		}
		el=me._ht_video_file_image0=document.createElement('div');
		els=me._ht_video_file_image0__img=document.createElement('img');
		els.className='ggskin ggskin_ht_video_file_image0';
		hs=basePath + 'images/ht_video_file_image0.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs=basePath + 'images/ht_video_file_image0__o.png';
		me._ht_video_file_image0__img.ggOverSrc=hs;
		el.ggId="ht_video_file_image";
		el.ggDx=0;
		el.ggDy=-4;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_video_file_image0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_video_file_image0.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image0.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._ht_video_file_image0.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._ht_video_file_image0.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image0.ggCurrentLogicStateScaling == 0) {
					me._ht_video_file_image0.ggParameter.sx = 0.8;
					me._ht_video_file_image0.ggParameter.sy = 0.8;
					me._ht_video_file_image0.style[domTransform]=parameterToTransform(me._ht_video_file_image0.ggParameter);
				}
				else {
					me._ht_video_file_image0.ggParameter.sx = 1;
					me._ht_video_file_image0.ggParameter.sy = 1;
					me._ht_video_file_image0.style[domTransform]=parameterToTransform(me._ht_video_file_image0.ggParameter);
				}
			}
		}
		me._ht_video_file_image0.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image0.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_video_file_image0.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_video_file_image0.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image0.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file_image0.style.visibility="hidden";
					me._ht_video_file_image0.style.opacity=0;
				}
				else {
					me._ht_video_file_image0.style.visibility=me._ht_video_file_image0.ggVisible?'inherit':'hidden';
					me._ht_video_file_image0.style.opacity=1;
				}
			}
		}
		me._ht_video_file_image0.onmouseover=function (e) {
			me._ht_video_file_image0__img.src=me._ht_video_file_image0__img.ggOverSrc;
		}
		me._ht_video_file_image0.onmouseout=function (e) {
			me._ht_video_file_image0__img.src=me._ht_video_file_image0__img.ggNormalSrc;
		}
		me._ht_video_file_image0.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_video_file_mod_2.appendChild(me._ht_video_file_image0);
		el=me._ht_video_file_image_20=document.createElement('div');
		els=me._ht_video_file_image_20__img=document.createElement('img');
		els.className='ggskin ggskin_ht_video_file_image_20';
		hs=basePath + 'images/ht_video_file_image_20.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs=basePath + 'images/ht_video_file_image_20__o.png';
		me._ht_video_file_image_20__img.ggOverSrc=hs;
		el.ggId="ht_video_file_image_2";
		el.ggDx=0;
		el.ggDy=-4;
		el.ggParameter={ rx:0,ry:0,a:0,sx:0.8,sy:0.8 };
		el.ggVisible=true;
		...
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me._ht_video_file_image_20.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_video_file_image_20.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image_20.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._ht_video_file_image_20.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._ht_video_file_image_20.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image_20.ggCurrentLogicStateScaling == 0) {
					me._ht_video_file_image_20.ggParameter.sx = 1;
					me._ht_video_file_image_20.ggParameter.sy = 1;
					me._ht_video_file_image_20.style[domTransform]=parameterToTransform(me._ht_video_file_image_20.ggParameter);
				}
				else {
					me._ht_video_file_image_20.ggParameter.sx = 0.8;
					me._ht_video_file_image_20.ggParameter.sy = 0.8;
					me._ht_video_file_image_20.style[domTransform]=parameterToTransform(me._ht_video_file_image_20.ggParameter);
				}
			}
		}
		me._ht_video_file_image_20.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image_20.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_video_file_image_20.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_video_file_image_20.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image_20.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file_image_20.style.visibility=me._ht_video_file_image_20.ggVisible?'inherit':'hidden';
					me._ht_video_file_image_20.style.opacity=1;
				}
				else {
					me._ht_video_file_image_20.style.visibility="hidden";
					me._ht_video_file_image_20.style.opacity=0;
				}
			}
		}
		me._ht_video_file_image_20.onmouseover=function (e) {
			me._ht_video_file_image_20__img.src=me._ht_video_file_image_20__img.ggOverSrc;
		}
		me._ht_video_file_image_20.onmouseout=function (e) {
			me._ht_video_file_image_20__img.src=me._ht_video_file_image_20__img.ggNormalSrc;
		}
		me._ht_video_file_image_20.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_video_file_mod_2.appendChild(me._ht_video_file_image_20);
		...
		me._tt_ht_video_file0.logicBlock_position = function() {
			...
			if (me._tt_ht_video_file0.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._tt_ht_video_file0.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					me._tt_ht_video_file0.style.top='-50px';
					me._tt_ht_video_file0.ggUpdatePosition(true);
				}
				else {
					me._tt_ht_video_file0.ggDx=0;
					me._tt_ht_video_file0.style.top='22px';
					me._tt_ht_video_file0.ggUpdatePosition(true);
				}
			}
		}
		...
		me._ht_video_file_mod_2.appendChild(me._tt_ht_video_file0);
		me.__div = me._ht_video_file_mod_2;
	};
	function SkinHotspotClass_ht_video_file_mod(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_video_file_mod=document.createElement('div');
		el.ggId="ht_video_file_mod";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_video_file_mod.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return me.hotspot.url.substr(1, me.hotspot.url.length - 2);
		}
		me._ht_video_file_mod.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_userdata') == true) || 
				(player.getVariableValue('vis_image_popup') == true) || 
			...
			if (me._ht_video_file_mod.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._ht_video_file_mod.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._ht_video_file_mod.style[domTransition]='opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_mod.ggCurrentLogicStateVisible == 0) {
					me._ht_video_file_mod.style.visibility="hidden";
					me._ht_video_file_mod.ggVisible=false;
				}
				else {
					me._ht_video_file_mod.style.visibility=(Number(me._ht_video_file_mod.style.opacity)>0||!me._ht_video_file_mod.style.opacity)?'inherit':'hidden';
					me._ht_video_file_mod.ggVisible=true;
				}
			}
		}
		me._ht_video_file_mod.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('vis_timer') == true)
			)
			...
			if (me._ht_video_file_mod.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_video_file_mod.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_video_file_mod.style[domTransition]='opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_mod.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file_mod.style.visibility=me._ht_video_file_mod.ggVisible?'inherit':'hidden';
					me._ht_video_file_mod.style.opacity=1;
				}
				else {
					me._ht_video_file_mod.style.visibility="hidden";
					me._ht_video_file_mod.style.opacity=0;
				}
			}
		}
		me._ht_video_file_mod.onclick=function (e) {
			skin._popup_video_file.ggInitMedia(player.getBasePath()+""+me.hotspot.url);
			player.setVariableValue('vis_video_popup_file', true);
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['ht_video_file_mod']=true;
			me._tt_ht_video_file.logicBlock_visible();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod.onmouseout=function (e) {
			player.setActiveHotspot(null);
			me.elementMouseOver['ht_video_file_mod']=false;
			me._tt_ht_video_file.logicBlock_visible();
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._ht_video_file_mod.ontouchend=function (e) {
			me.elementMouseOver['ht_video_file_mod']=false;
			me._tt_ht_video_file.logicBlock_visible();
		}
		me._ht_video_file_mod.ggUpdatePosition=function (useTransition) {
		}
		el=me._ht_video_file_image=document.createElement('div');
		els=me._ht_video_file_image__img=document.createElement('img');
		els.className='ggskin ggskin_ht_video_file_image';
		hs=basePath + 'images/ht_video_file_image.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs=basePath + 'images/ht_video_file_image__o.png';
		...
		me._ht_video_file_image.logicBlock_scaling = function() {
			...
			if (me._ht_video_file_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._ht_video_file_image.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image.ggCurrentLogicStateScaling == 0) {
					me._ht_video_file_image.ggParameter.sx = 0.8;
					me._ht_video_file_image.ggParameter.sy = 0.8;
		...
		me._ht_video_file_image.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_video_file_image.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_video_file_image.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file_image.style.visibility="hidden";
					me._ht_video_file_image.style.opacity=0;
				}
				else {
					me._ht_video_file_image.style.visibility=me._ht_video_file_image.ggVisible?'inherit':'hidden';
					me._ht_video_file_image.style.opacity=1;
				}
			}
		}
		...
		me._ht_video_file_mod.appendChild(me._ht_video_file_image);
		el=me._ht_video_file_image_2=document.createElement('div');
		els=me._ht_video_file_image_2__img=document.createElement('img');
		els.className='ggskin ggskin_ht_video_file_image_2';
		hs=basePath + 'images/ht_video_file_image_2.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs=basePath + 'images/ht_video_file_image_2__o.png';
		me._ht_video_file_image_2__img.ggOverSrc=hs;
		el.ggId="ht_video_file_image_2";
		el.ggDx=0;
		el.ggDy=-4;
		el.ggParameter={ rx:0,ry:0,a:0,sx:0.8,sy:0.8 };
		...
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me._ht_video_file_image_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_video_file_image_2.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image_2.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._ht_video_file_image_2.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._ht_video_file_image_2.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image_2.ggCurrentLogicStateScaling == 0) {
					me._ht_video_file_image_2.ggParameter.sx = 1;
					me._ht_video_file_image_2.ggParameter.sy = 1;
					me._ht_video_file_image_2.style[domTransform]=parameterToTransform(me._ht_video_file_image_2.ggParameter);
				}
				else {
					me._ht_video_file_image_2.ggParameter.sx = 0.8;
					me._ht_video_file_image_2.ggParameter.sy = 0.8;
					me._ht_video_file_image_2.style[domTransform]=parameterToTransform(me._ht_video_file_image_2.ggParameter);
				}
			}
		}
		me._ht_video_file_image_2.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me._ht_video_file_image_2.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._ht_video_file_image_2.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._ht_video_file_image_2.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._ht_video_file_image_2.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file_image_2.style.visibility=me._ht_video_file_image_2.ggVisible?'inherit':'hidden';
					me._ht_video_file_image_2.style.opacity=1;
				}
				else {
					me._ht_video_file_image_2.style.visibility="hidden";
					me._ht_video_file_image_2.style.opacity=0;
				}
			}
		}
		me._ht_video_file_image_2.onmouseover=function (e) {
			me._ht_video_file_image_2__img.src=me._ht_video_file_image_2__img.ggOverSrc;
		}
		me._ht_video_file_image_2.onmouseout=function (e) {
			me._ht_video_file_image_2__img.src=me._ht_video_file_image_2__img.ggNormalSrc;
		}
		me._ht_video_file_image_2.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_video_file_mod.appendChild(me._ht_video_file_image_2);
		...
		me._ht_video_file_mod.appendChild(me._tt_ht_video_file);
		me.__div = me._ht_video_file_mod;
	};
	...
	function SkinHotspotClass_ht_3d_modele_2(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_3d_modele_2=document.createElement('div');
		el.ggId="ht_3d_modele_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_3d_modele_2.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return me.hotspot.url.substr(1, me.hotspot.url.length - 2);
		}
		me._ht_3d_modele_2.onclick=function (e) {
			skin._info_title.ggText=me.hotspot.title;
			skin._info_title.ggTextDiv.innerHTML=skin._info_title.ggText;
			if (skin._info_title.ggUpdateText) {
				skin._info_title.ggUpdateText=function() {
		...
		me._ht_3d_modele_2.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_3d_modele_2.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['ht_3d_modele_2']=true;
			me._ht_tt2.logicBlock_visible();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._ht_3d_modele_2.onmouseout=function (e) {
			player.setActiveHotspot(null);
			me.elementMouseOver['ht_3d_modele_2']=false;
			me._ht_tt2.logicBlock_visible();
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._ht_3d_modele_2.ontouchend=function (e) {
			me.elementMouseOver['ht_3d_modele_2']=false;
			me._ht_tt2.logicBlock_visible();
		}
		me._ht_3d_modele_2.ggUpdatePosition=function (useTransition) {
		}
		el=me.__3d_model_4=document.createElement('div');
		els=me.__3d_model_4__img=document.createElement('img');
		els.className='ggskin ggskin__3d_model_4';
		hs=basePath + 'images/_3d_model_4.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me.__3d_model_4.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__3d_model_4.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model_4.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me.__3d_model_4.ggCurrentLogicStateScaling = newLogicStateScaling;
				me.__3d_model_4.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model_4.ggCurrentLogicStateScaling == 0) {
					me.__3d_model_4.ggParameter.sx = 0.8;
					me.__3d_model_4.ggParameter.sy = 0.8;
					me.__3d_model_4.style[domTransform]=parameterToTransform(me.__3d_model_4.ggParameter);
				}
				else {
					me.__3d_model_4.ggParameter.sx = 1;
					me.__3d_model_4.ggParameter.sy = 1;
					me.__3d_model_4.style[domTransform]=parameterToTransform(me.__3d_model_4.ggParameter);
				}
			}
		}
		me.__3d_model_4.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model_4.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__3d_model_4.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__3d_model_4.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model_4.ggCurrentLogicStateAlpha == 0) {
					me.__3d_model_4.style.visibility="hidden";
					me.__3d_model_4.style.opacity=0;
				}
				else {
					me.__3d_model_4.style.visibility=me.__3d_model_4.ggVisible?'inherit':'hidden';
					me.__3d_model_4.style.opacity=1;
				}
			}
		}
		me.__3d_model_4.ggUpdatePosition=function (useTransition) {
		}
		me._ht_3d_modele_2.appendChild(me.__3d_model_4);
		el=me.__3d_model_3=document.createElement('div');
		els=me.__3d_model_3__img=document.createElement('img');
		els.className='ggskin ggskin__3d_model_3';
		hs=basePath + 'images/_3d_model_3.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me.__3d_model_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__3d_model_3.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model_3.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me.__3d_model_3.ggCurrentLogicStateScaling = newLogicStateScaling;
				me.__3d_model_3.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model_3.ggCurrentLogicStateScaling == 0) {
					me.__3d_model_3.ggParameter.sx = 1;
					me.__3d_model_3.ggParameter.sy = 1;
					me.__3d_model_3.style[domTransform]=parameterToTransform(me.__3d_model_3.ggParameter);
				}
				else {
					me.__3d_model_3.ggParameter.sx = 0.8;
					me.__3d_model_3.ggParameter.sy = 0.8;
					me.__3d_model_3.style[domTransform]=parameterToTransform(me.__3d_model_3.ggParameter);
				}
			}
		}
		me.__3d_model_3.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model_3.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__3d_model_3.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__3d_model_3.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model_3.ggCurrentLogicStateAlpha == 0) {
					me.__3d_model_3.style.visibility=me.__3d_model_3.ggVisible?'inherit':'hidden';
					me.__3d_model_3.style.opacity=1;
				}
				else {
					me.__3d_model_3.style.visibility="hidden";
					me.__3d_model_3.style.opacity=0;
				}
			}
		}
		me.__3d_model_3.ggUpdatePosition=function (useTransition) {
		}
		me._ht_3d_modele_2.appendChild(me.__3d_model_3);
		el=me._ht_tt2=document.createElement('div');
		els=me._ht_tt2__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="ht_tt-2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		els.innerHTML=me.hotspot.title;
		el.appendChild(els);
		me._ht_tt2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_tt2.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['ht_3d_modele_2'] == true)
			)
			...
			if (me._ht_tt2.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._ht_tt2.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._ht_tt2.style[domTransition]='';
				if (me._ht_tt2.ggCurrentLogicStateVisible == 0) {
					me._ht_tt2.style.visibility=(Number(me._ht_tt2.style.opacity)>0||!me._ht_tt2.style.opacity)?'inherit':'hidden';
					me._ht_tt2.ggVisible=true;
				}
				else {
					me._ht_tt2.style.visibility="hidden";
					me._ht_tt2.ggVisible=false;
				}
			}
		}
		me._ht_tt2.ggUpdatePosition=function (useTransition) {
			this.style[domTransition]='left 0';
			this.ggTextDiv.style.left=((98-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		me._ht_3d_modele_2.appendChild(me._ht_tt2);
		me.__div = me._ht_3d_modele_2;
	};
	function SkinHotspotClass_ht_3d_modele(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_3d_modele=document.createElement('div');
		el.ggId="ht_3d_modele";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_3d_modele.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return me.hotspot.url.substr(1, me.hotspot.url.length - 2);
		}
		me._ht_3d_modele.onclick=function (e) {
			skin._info_title.ggText=me.hotspot.title;
			skin._info_title.ggTextDiv.innerHTML=skin._info_title.ggText;
			if (skin._info_title.ggUpdateText) {
				skin._info_title.ggUpdateText=function() {
		...
		me._ht_3d_modele.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_3d_modele.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['ht_3d_modele']=true;
			me._ht_tt.logicBlock_visible();
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._ht_3d_modele.onmouseout=function (e) {
			player.setActiveHotspot(null);
			me.elementMouseOver['ht_3d_modele']=false;
			me._ht_tt.logicBlock_visible();
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._ht_3d_modele.ontouchend=function (e) {
			me.elementMouseOver['ht_3d_modele']=false;
			me._ht_tt.logicBlock_visible();
		}
		me._ht_3d_modele.ggUpdatePosition=function (useTransition) {
		}
		el=me.__3d_model=document.createElement('div');
		els=me.__3d_model__img=document.createElement('img');
		els.className='ggskin ggskin__3d_model';
		hs=basePath + 'images/_3d_model.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me.__3d_model.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__3d_model.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me.__3d_model.ggCurrentLogicStateScaling = newLogicStateScaling;
				me.__3d_model.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model.ggCurrentLogicStateScaling == 0) {
					me.__3d_model.ggParameter.sx = 0.8;
					me.__3d_model.ggParameter.sy = 0.8;
					me.__3d_model.style[domTransform]=parameterToTransform(me.__3d_model.ggParameter);
				}
				else {
					me.__3d_model.ggParameter.sx = 1;
					me.__3d_model.ggParameter.sy = 1;
					me.__3d_model.style[domTransform]=parameterToTransform(me.__3d_model.ggParameter);
				}
			}
		}
		me.__3d_model.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__3d_model.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__3d_model.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model.ggCurrentLogicStateAlpha == 0) {
					me.__3d_model.style.visibility="hidden";
					me.__3d_model.style.opacity=0;
				}
				else {
					me.__3d_model.style.visibility=me.__3d_model.ggVisible?'inherit':'hidden';
					me.__3d_model.style.opacity=1;
				}
			}
		}
		me.__3d_model.ggUpdatePosition=function (useTransition) {
		}
		me._ht_3d_modele.appendChild(me.__3d_model);
		el=me.__3d_model_2=document.createElement('div');
		els=me.__3d_model_2__img=document.createElement('img');
		els.className='ggskin ggskin__3d_model_2';
		hs=basePath + 'images/_3d_model_2.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me.__3d_model_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__3d_model_2.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model_2.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me.__3d_model_2.ggCurrentLogicStateScaling = newLogicStateScaling;
				me.__3d_model_2.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model_2.ggCurrentLogicStateScaling == 0) {
					me.__3d_model_2.ggParameter.sx = 1;
					me.__3d_model_2.ggParameter.sy = 1;
					me.__3d_model_2.style[domTransform]=parameterToTransform(me.__3d_model_2.ggParameter);
				}
				else {
					me.__3d_model_2.ggParameter.sx = 0.8;
					me.__3d_model_2.ggParameter.sy = 0.8;
					me.__3d_model_2.style[domTransform]=parameterToTransform(me.__3d_model_2.ggParameter);
				}
			}
		}
		me.__3d_model_2.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				(player.getVariableValue('animation') == true)
			)
			...
			if (me.__3d_model_2.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__3d_model_2.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__3d_model_2.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__3d_model_2.ggCurrentLogicStateAlpha == 0) {
					me.__3d_model_2.style.visibility=me.__3d_model_2.ggVisible?'inherit':'hidden';
					me.__3d_model_2.style.opacity=1;
				}
				else {
					me.__3d_model_2.style.visibility="hidden";
					me.__3d_model_2.style.opacity=0;
				}
			}
		}
		me.__3d_model_2.ggUpdatePosition=function (useTransition) {
		}
		me._ht_3d_modele.appendChild(me.__3d_model_2);
		...
		me._ht_3d_modele.appendChild(me._ht_tt);
		me.__div = me._ht_3d_modele;
	};
	me.addSkinHotspot=function(hotspot) {
		...
		if (hotspot.skinid=='ht_node') {
			...
			me.callChildLogicBlocksHotspot_ht_node_varchanged_animation();;
		...
		if (hotspot.skinid=='ht_image') {
			...
			me.callChildLogicBlocksHotspot_ht_image_varchanged_animation();;
		} else
		...
		if (hotspot.skinid=='ht_video_file_mod_2') {
			hotspot.skinid = 'ht_video_file_mod_2';
			hsinst = new SkinHotspotClass_ht_video_file_mod_2(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_changenodeid();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_configloaded();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_mouseover();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_timer();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_userdata();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_image_popup();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_info_popup();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_file();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_url();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_vimeo();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_video_popup_youtube();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_vis_website();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_animation();;
		} else
		if (hotspot.skinid=='ht_video_file_mod') {
			hotspot.skinid = 'ht_video_file_mod';
			hsinst = new SkinHotspotClass_ht_video_file_mod(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_video_file_mod_changenodeid();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_configloaded();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_mouseover();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_timer();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_userdata();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_image_popup();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_info_popup();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_file();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_url();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_vimeo();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_video_popup_youtube();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_vis_website();;
			me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_animation();;
		} else
		...
		if (hotspot.skinid=='ht_3d_modele_2') {
			hotspot.skinid = 'ht_3d_modele_2';
			hsinst = new SkinHotspotClass_ht_3d_modele_2(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_3d_modele_2_changenodeid();;
			me.callChildLogicBlocksHotspot_ht_3d_modele_2_mouseover();;
			me.callChildLogicBlocksHotspot_ht_3d_modele_2_varchanged_animation();;
		} else
		{
			hotspot.skinid = 'ht_3d_modele';
			hsinst = new SkinHotspotClass_ht_3d_modele(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_3d_modele_changenodeid();;
			me.callChildLogicBlocksHotspot_ht_3d_modele_mouseover();;
			me.callChildLogicBlocksHotspot_ht_3d_modele_varchanged_animation();;
		}
		return hsinst;
	}
	me.removeSkinHotspots=function() {
		...
		if(hotspotTemplates['ht_video_file_mod_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod_2'].length; i++) {
				hotspotTemplates['ht_video_file_mod_2'][i] = null;
			}
		}
		if(hotspotTemplates['ht_video_file_mod']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file_mod'].length; i++) {
				hotspotTemplates['ht_video_file_mod'][i] = null;
			}
		}
		if(hotspotTemplates['ht_video_url']) {
			var i;
		...
		if(hotspotTemplates['ht_3d_modele_2']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele_2'].length; i++) {
				hotspotTemplates['ht_3d_modele_2'][i] = null;
			}
		}
		if(hotspotTemplates['ht_3d_modele']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_3d_modele'].length; i++) {
				hotspotTemplates['ht_3d_modele'][i] = null;
			}
		}
		hotspotTemplates = [];
	}
	...
	me._compasspointer.logicBlock_visible();
	...
	me._information_3.logicBlock_visible();
	...
	player.addListener('changenodeid', function(args) { me._show_controller_button.logicBlock_position();me._loading_multires.logicBlock_visible();me._screentint.logicBlock_alpha();me._controller.logicBlock_position();me._controller.logicBlock_alpha();me._controller_slider.logicBlock_position();me._fullscreen_buttons.logicBlock_position();me._fullscreen_buttons.logicBlock_visible();me._gyro.logicBlock_position();me._gyro.logicBlock_visible();me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha();me._tt_gyro.logicBlock_text();me._projection_buttons.logicBlock_position();me._projection_buttons.logicBlock_visible();me._thumbnail.logicBlock_position();me._thumbnail.logicBlock_visible();me._tt_thumbnail_open.logicBlock_text();me._info.logicBlock_position();me._info.logicBlock_visible();me._autorotate_buttons.logicBlock_position();me._autorotate_buttons.logicBlock_visible();me._autorotate_start.logicBlock_alpha();me._autorotate_stop.logicBlock_alpha();me._tt_rotate.logicBlock_text();me._zoomout.logicBlock_visible();me._zoomin.logicBlock_visible();me._thumbnail_menu.logicBlock_position();me._thumbnail_menu.logicBlock_visible();me._thumbnail_menu.logicBlock_alpha();me._thumbnail_menu_mobile.logicBlock_position();me._thumbnail_menu_mobile.logicBlock_visible();me._thumbnail_menu_mobile.logicBlock_alpha();me._web_page.logicBlock_visible();me._compasspointer.logicBlock_visible();me._beamdot.logicBlock_visible();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._userdata.logicBlock_visible();me._information_2.logicBlock_visible();me._information.logicBlock_visible();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._video_popup_url.logicBlock_visible();me._popup_video_url.logicBlock_visible();me._video_popup_controls_url.logicBlock_visible();me._video_popup_vimeo.logicBlock_visible();me._popup_video_vimeo.logicBlock_visible();me._video_popup_youtube.logicBlock_visible();me._popup_video_youtube.logicBlock_visible();me._information_3.logicBlock_visible();me.__360image_gyro.logicBlock_visible();me.__360image.logicBlock_position();me.__360image.logicBlock_scaling();me._phone2.logicBlock_scaling();me._phone3.logicBlock_scaling();me._close.logicBlock_visible();me._loading.logicBlock_visible(); });
	...
	player.addListener('varchanged_Open_portada', function(args) { me._information_3.logicBlock_visible();me._close.logicBlock_visible(); });
	...
	player.addListener('varchanged_var_compass', function(args) { me._compasspointer.logicBlock_visible();me._beamdot.logicBlock_visible(); });
	...
	player.addListener('varchanged_animation', function(args) { me.callChildLogicBlocksHotspot_ht_node_varchanged_animation();me.callChildLogicBlocksHotspot_ht_image_varchanged_animation();me.callChildLogicBlocksHotspot_ht_video_file_mod_2_varchanged_animation();me.callChildLogicBlocksHotspot_ht_video_file_mod_varchanged_animation();me.callChildLogicBlocksHotspot_ht_3d_modele_2_varchanged_animation();me.callChildLogicBlocksHotspot_ht_3d_modele_varchanged_animation(); });
